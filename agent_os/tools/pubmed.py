...
def register_pubmed_tools(r) -> None:
    r.register("pubmed_search", "retrieval", {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "query": {"type": "string", "description": "搜索词。用英文，2-5 个高信息熵词"},
                "article_type": {
                    "type": "string",
                    "description": "EBM 文章类型。常用：systematic_review, rct, meta_analysis, guideline。其余：review, observational, case_report",
                },
                "clinical_query": {
                    "type": "string",
                    "description": "EBM 临床查询: therapy, diagnosis, prognosis, etiology。自动应用 PubMed 验证的检索策略",
                },
                "pmid": {"type": "string", "description": "按 PMID 精确查找，返回完整元数据 + grade_readiness"},
                "pmids": {"type": "string", "description": "批量 PMID 查找，空格/逗号分隔"},
                "author": {"type": "string", "description": "可选，作者名"},
                "title": {"type": "string", "description": "可选，标题词"},
                "journal": {"type": "string", "description": "可选，期刊名"},
                "year": {"type": "string", "description": "可选，年份"},
                "mesh": {"type": "string", "description": "可选，MeSH 主题词"},
                "clinical_query_sensitivity": {"type": "string", "description": "可选，broad/narrow，默认 broad"},
