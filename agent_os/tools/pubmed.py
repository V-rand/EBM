    ...
    r.register("pubmed_search", "retrieval", {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "article_type": {
                    "type": "string",
                    "description": "systematic_review | rct | meta_analysis | guideline | review | observational | case_report",
                },
                "clinical_query": {
                    "type": "string",
                    "description": "therapy | diagnosis | prognosis | etiology (validated PubMed Clinical Queries)",
                },
                "pmid": {"type": "string", "description": "Lookup by PubMed ID, returns full metadata + grade_readiness"},
                "pmids": {"type": "string", "description": "Batch PMID lookup, space or comma separated"},
                "author": {"type": "string", "description": "Author name"},
                "title": {"type": "string", "description": "Title words"},
                "journal": {"type": "string", "description": "Journal name"},
                "year": {"type": "string", "description": "Publication year"},
                "mesh": {"type": "string", "description": "MeSH term"},
                "clinical_query_sensitivity": {"type": "string", "description": "broad (default) | narrow"},
