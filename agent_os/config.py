...
_api_hosts = {"api.deepseek.com", "dashscope.aliyuncs.com", "cdn-mineru.openxlab.org.cn"}
...
class Settings:
    ...
    blind_search_guardrail_rounds: int = _y("blind_search_guardrail_rounds", 9)
    domain_router_model: str = _y("domain_router_model", "deepseek-v4-flash")
